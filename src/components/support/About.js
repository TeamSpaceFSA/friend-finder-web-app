...
const About = () => {
  ...
  return (
    <div className="about">
      ...
      <h1 className="aboutIntro">We find you new friends based on common interests</h1>

      <p className="aboutDescription">
        New Friends began as an idea formulated by Andrea, known as Dre, in
        2022. Soon after, the social app idea was introduced to her team and fellow
        ...
        voting and deliberating, amongst 30+ ideas, New Friends was chosen out
        of the bunch. In the 2.5 week project deadline, the team made a MVP
      ...
      <div className="creatorNotes">
        ...
        <div className="creator">
          ...
          <p>
            ...
            to make friends or simply meet people with common interests. This
            app closes that gap! As next steps, along with my fellow creators
            (if they're interested of course, hehe), I would like to expand the
            app and have it deployed for public use!" &#x1F64F;&#127997;
          </p>
        </div>
