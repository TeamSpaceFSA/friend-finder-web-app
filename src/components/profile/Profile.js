...
const Profile = () => {
  ...
  return (
    <>
        ...
        <Link to="editprofile">
          <img
            src="https://i.pinimg.com/originals/53/79/9d/53799d51a62bd28cb04c8a4c57f054c9.png"
            style={{ height: "50px", width: "50px" }}
            alt=""
          />
        </Link>
        ...
        <Link to="friendslist">
          <button>
            <img
              src="https://cdn0.iconfinder.com/data/icons/typicons-2/24/contacts-1024.png"
              width={35}
              height={35}
              alt=""
            />
